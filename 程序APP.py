...
with st.sidebar:
    ...
    ### 特征描述
    - **FCTI总分**: 家庭照顾者能力量表总分 0 ~ 40
    - **Age**: 年龄 70 ~ 98
    - **Ser**: 血清白蛋白 20.0 ~ 60.0 (g/L)
    - **Fra**: 骨折类型 包括颈椎骨折、胸椎骨折、腰椎骨折、股骨颈骨折、股骨粗隆间骨折、股骨干骨折、胫腓骨上段骨折、尾骨粉碎性骨折、骶髂关节脱位、髋骨骨折、髌骨粉碎性骨折、髋关节内骨折、脆性骨折和其他共14类
    - **Air**: 是否使用气垫床或充气床垫
    - **Com**: 患合并症数量 0 ~ 8  合并症包括神经系统疾病、自身免疫性疾病、糖尿病、水肿、中风、下肢静脉血栓、冠心病和高血压等共8种
    - **PCAT总分**: 基层医疗质量评估量表总分 1 ~ 4
    - **Mlu**: 是否为多发性骨折
